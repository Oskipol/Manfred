...
export async function rag(url: string) {
    ...
    //     const messages = await prompTemplate.invoke({question: state.question, context: docsContent})
    ...
    const retrievedDocs = await vectorStore.similaritySearch('Summarize this website');
